...
function PhraseError(message){
    ...
    Error.captureStackTrace(this, PhraseError); //Получает текущий стек и сохраняет в this
    //PhraseError убираем лишний стек
}
util.inherits(PhraseError, Error); //Наследуем
